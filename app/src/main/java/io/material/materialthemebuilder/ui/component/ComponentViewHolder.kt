...
import io.material.materialthemebuilder.ui.component.Component.FABMENUS
import io.material.materialthemebuilder.ui.component.Component.SEARCHVIEW
...
sealed class ComponentViewHolder(val view: View) : RecyclerView.ViewHolder(view)
{
    ...
    class SearchViewHolder(
            parent: ViewGroup
    ) : ComponentViewHolder(inflate(parent, R.layout.component_searchview))
    ...
    class FabMenusComponentViewHolder(
            parent: ViewGroup
    ) : ComponentViewHolder(inflate(parent, R.layout.component_fabmenus))
    {
        init
        {
        }
    ...
    companion object
    {
        ...
        ): ComponentViewHolder
        {
            return when (Component.values()[viewType])
            {
                ...
                SEARCHVIEW        -> ComponentViewHolder.SearchViewHolder(parent)
                FABMENUS          -> ComponentViewHolder.FabMenusComponentViewHolder(parent)
            }
        }
